    ...
    <div class="row" id="location_modal">
        <div class="col-6 border-left" id="frm-field">
            ...
            <input type="hidden" name="date_sched" value="<?php echo $_GET['d'] ?>">
                ...
                <div class="form-group">
                    <label for="gender" class="control-label">Timing</label>
                    <select type="text" class="custom-select" name="time" required>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
                        ...
                        var ins = "<small><i>Copy or take a snapshot of the code below your name. The code will serve as your ticket number for your voting schedule. Please bring your VoterID and the above to verify your schedule information.</i></small>";
